// ======================================================================
// \title  CompDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef COMPDEPLOYMENT_COMPDEPLOYMENTTOPOLOGY_HPP
#define COMPDEPLOYMENT_COMPDEPLOYMENTTOPOLOGY_HPP
// Included for access to CompDeployment::TopologyState and CompDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <CompDeployment/Top/CompDeploymentTopologyDefs.hpp>

// Remove unnecessary CompDeployment:: qualifications
using namespace CompDeployment;
namespace CompDeployment {
/**
 ...
 * CompDeployment::TopologyState see: CompDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type CompDeployment::TopologyState see: CompDeploymentTopologyDefs.hpp.
 *
