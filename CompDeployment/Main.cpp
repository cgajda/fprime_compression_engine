...
#include <CompDeployment/Top/CompDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    CompDeployment::TopologyState inputs;
    ...
    CompDeployment::setupTopology(inputs);
    CompDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    CompDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
